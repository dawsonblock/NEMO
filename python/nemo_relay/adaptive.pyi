...
class SingleFlightLimits:
    ...
    max_global_provider_concurrency: int = ...
    max_provider_concurrency: int = ...
    max_model_concurrency: int = ...
    max_global_waiters: int = ...
    max_pending_provider_requests: int = ...
    max_pending_provider_per_provider: int = ...
    provider_admission_timeout_ms: int = ...
